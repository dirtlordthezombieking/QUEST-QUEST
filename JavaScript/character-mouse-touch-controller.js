	...
	touchMouseEnd(x,y)
	{
			...
			if(y<256)
			{
				...
				else if(y>=-52)
				{
					...
					if(x>=-312)
					{
						if(x<-304)
						{
							characterScreen.char.detailColour[0]=utils.clamp(characterScreen.char.detailColour[0]+(16*add),0,255);
						}
						else if(x<-296)
						{
							characterScreen.char.detailColour[0]=utils.clamp(characterScreen.char.detailColour[0]+add,0,255);
						}
						else if(x<-288)
						{
							characterScreen.char.detailColour[1]=utils.clamp(characterScreen.char.detailColour[1]+(16*add),0,255);
						}
						else if(x<-280)
						{
							characterScreen.char.detailColour[1]=utils.clamp(characterScreen.char.detailColour[1]+add,0,255);
						}
						else if(x<-272)
						{
							characterScreen.char.detailColour[2]=utils.clamp(characterScreen.char.detailColour[2]+(16*add),0,255);
						}
						else if(x<-264)
						{
							characterScreen.char.detailColour[2]=utils.clamp(characterScreen.char.detailColour[2]+add,0,255);
						}
					}
				}
				else if(y>=-156){}
			...
			if(y<256)
			{
				...
				else if(y>=156)
				{
					...
					if(x>=328)
					{
						if(x<336)
						{
							characterScreen.char.shirtColour[0]=utils.clamp(characterScreen.char.shirtColour[0]+(16*add),0,255);
						}
						else if(x<344)
						{
							characterScreen.char.shirtColour[0]=utils.clamp(characterScreen.char.shirtColour[0]+add,0,255);
						}
						else if(x<352)
						{
							characterScreen.char.shirtColour[1]=utils.clamp(characterScreen.char.shirtColour[1]+(16*add),0,255);
						}
						else if(x<360)
						{
							characterScreen.char.shirtColour[1]=utils.clamp(characterScreen.char.shirtColour[1]+add,0,255);
						}
						else if(x<368)
						{
							characterScreen.char.shirtColour[2]=utils.clamp(characterScreen.char.shirtColour[2]+(16*add),0,255);
						}
						else if(x<376)
						{
							characterScreen.char.shirtColour[2]=utils.clamp(characterScreen.char.shirtColour[2]+add,0,255);
						}
					}
				}
				else if(y>=52){}
				else if(y>=20)
				{
					...
					if(x>=328)
					{
						if(x<336)
						{
							characterScreen.char.pantsColour[0]=utils.clamp(characterScreen.char.pantsColour[0]+(16*add),0,255);
						}
						else if(x<344)
						{
							characterScreen.char.pantsColour[0]=utils.clamp(characterScreen.char.pantsColour[0]+add,0,255);
						}
						else if(x<352)
						{
							characterScreen.char.pantsColour[1]=utils.clamp(characterScreen.char.pantsColour[1]+(16*add),0,255);
						}
						else if(x<360)
						{
							characterScreen.char.pantsColour[1]=utils.clamp(characterScreen.char.pantsColour[1]+add,0,255);
						}
						else if(x<368)
						{
							characterScreen.char.pantsColour[2]=utils.clamp(characterScreen.char.pantsColour[2]+(16*add),0,255);
						}
						else if(x<376)
						{
							characterScreen.char.pantsColour[2]=utils.clamp(characterScreen.char.pantsColour[2]+add,0,255);
						}
					}
				}
				else if(y>=-84){}
				else if(y>=-116)
				{
					...
					if(x>=328)
					{
						if(x<336)
						{
							characterScreen.char.shoeColour[0]=utils.clamp(characterScreen.char.shoeColour[0]+(16*add),0,255);
						}
						else if(x<344)
						{
							characterScreen.char.shoeColour[0]=utils.clamp(characterScreen.char.shoeColour[0]+add,0,255);
						}
						else if(x<352)
						{
							characterScreen.char.shirtColour[1]=utils.clamp(characterScreen.char.shoeColour[1]+(16*add),0,255);
						}
						else if(x<360)
						{
							characterScreen.char.shoeColour[1]=utils.clamp(characterScreen.char.shoeColour[1]+add,0,255);
						}
						else if(x<368)
						{
							characterScreen.char.shoeColour[2]=utils.clamp(characterScreen.char.shoeColour[2]+(16*add),0,255);
						}
						else if(x<376)
						{
							characterScreen.char.shoeColour[2]=utils.clamp(characterScreen.char.shoeColour[2]+add,0,255);
						}
					}
				}
				else if(y>=-220){}
		...
		else if(y>=-224&&y<-192)
		{
			...
			if(x>=-184)
			{
				if(x<-176)
				{
					characterScreen.char.eyeColour[0]=utils.clamp(characterScreen.char.eyeColour[0]+(16*add),0,255);
				}
				else if(x<-168)
				{
					characterScreen.char.eyeColour[0]=utils.clamp(characterScreen.char.eyeColour[0]+add,0,255);
				}
				else if(x<-160)
				{
					characterScreen.char.eyeColour[1]=utils.clamp(characterScreen.char.eyeColour[1]+(16*add),0,255);
				}
				else if(x<-152)
				{
					characterScreen.char.eyeColour[1]=utils.clamp(characterScreen.char.eyeColour[1]+add,0,255);
				}
				else if(x<-144)
				{
					characterScreen.char.eyeColour[2]=utils.clamp(characterScreen.char.eyeColour[2]+(16*add),0,255);
				}
				else if(x<-136)
				{
					characterScreen.char.eyeColour[2]=utils.clamp(characterScreen.char.eyeColour[2]+add,0,255);
				}
			}
		}
	},
